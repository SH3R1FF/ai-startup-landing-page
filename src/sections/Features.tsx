...
const FeatureTab = (props: (typeof tabs)[number] & ComponentPropsWithoutRef<"div"> & { selected: boolean} ) => {
  ...
  useEffect(() => {
    ...
    animate(yPercentage, [0, 0, 100, 100, 0], options); }, [props.selected]);
...
export const Features = () => {
  ...
  return <section className="py-20 md:py-24">
    <div className="container">
      ...
      <p className="text-white/70 text-lg md:text-xl max-w-2xl mx-auto tracking-tight text-center mt-5 ">From small startups to large enterpises, our AI-driven tool has revolutionized the way businesses approach SEO.</p>
