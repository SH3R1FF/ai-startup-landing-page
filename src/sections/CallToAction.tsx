    ...
    <div className="container">
      <motion.div 
        ...
        <div className="relative">
          ...
          <p className="text-center text-lg md:text-xl max-w-xs  mx-auto text-white/70 px-4 mt-5 tracking-tight">Achieve clear, imapactful results without the complexity.</p>
