...
export const Testimonials = () => {
  return <section className="py-20 md:py-24">
    <div className="container">
      ...
      <p className="text-white/70 text-lg md:text-xl text-center mt-5 tracking-tighter max-w-sm mx-auto ">Our revolutionary AI SEO tools have transformed our clients</p>
        ...
        <motion.div 
          ...
          {[...testimonials,...testimonials].map(testimonial => (
            <div key={testimonial.name} className="border border-white/15 p-6 md:p-10 rounded-xl bg-[linear-gradient(to_bottom_left,rgb(140,69,255,.3),black)] max-w-xs md:max-w-md flex-none"> 
              <div className="text-lg md:text-2xl tracking-tighter">{testimonial.text}</div>
